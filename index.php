                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="Update.php?CustomerID=<?php echo $r['CustomerID']; ?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
                                <td><a href="deletecustomer.php?CustomerID=<?php echo $r['CustomerID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
                            </tr>
                        <?php }?>
                    </tbody>
                </table>
